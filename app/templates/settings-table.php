<?php
/**
 * Settings Table Template for RSS Posts Importer
...
<button type="button" class="rsspi_settings_control_button button button-primary" id="toggle-rsspi-settings-table">
    <?php esc_html_e('Settings', 'rss-posts-importer'); ?>
                    ...
                    <table class="widefat edit-table">
                            ...
                            <td>
                                ...
                                <select name="frequency" id="frequency">
                                    ...
                                    <option value="custom_frequency" <?php selected(($this->options['settings']['custom_frequency'] ?? ''), 'true'); ?>>
                                        <?php esc_html_e('Custom frequency', 'rss-posts-importer'); ?>
                                    </option>
                                </select>
                                &nbsp;
                                ...
                                <input type="text" id="rss_custom_frequency" name="rss_custom_frequency" 
                                    ...
                                    placeholder="<?php esc_attr_e('Minutes', 'rss-posts-importer'); ?>"
                            ...
                            <td>
                                ...
                                <div class="description">
                                    ...
                                    <dl>
                                        ...
                                        <dt><code>{$inline_image}</code> <small><?php esc_html_e('insert the featured image inline into the post content', 'rss-posts-importer'); ?></small></dt>
                                    </dl>
                                </div>
                            </td>
                            <td>
                                ...
                                <ul class="radiolist">
                                    <li>
                                        <label>
                                            ...
                                            <?php esc_html_e('Yes', 'rss-posts-importer'); ?>
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            ...
                                            <?php esc_html_e('No', 'rss-posts-importer'); ?>
                                        </label>
                                    </li>
                                </ul>
                            </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <p class="description"><?php esc_html_e('Add rel="nofollow" to all outbound links.', 'rss-posts-importer'); ?></p>
                            </td>
                            <td>
                                <ul class="radiolist">
                                    <li>
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    printf(
                                        ...
                                        esc_html__( 'The logfile can be found %1$shere%2$s.', 'rss-posts-importer' ),
