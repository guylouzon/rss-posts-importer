    ...
    <style>
        * {
        ...
        .button-warning {
            ...
            border-color: #833030 !important;
        }

        .button-warning:hover {
            background: #a01d1d !important;
        }
        ...
        /* Table wrapper for proper structure */
        .table-wrapper {
            width: 100%;
            margin-bottom: 20px;
        }
        ...
        /* Data rows - matching grid layout */
        .table-row.data-row {
            display: grid;
            grid-template-columns: 2fr 3fr 1fr;
            gap: 16px;
        ...
        /* Feed name column */
        .table-cell.rss_pi-feed_name {
            min-width: 0;
        }

        .table-cell.rss_pi-feed_name strong {
            display: block;
            width: 100%;
        }

        .table-cell.rss_pi-feed_name .toggle-edit {
            text-decoration: none;
            color: inherit;
            display: inline-flex;
            align-items: center;
        ...
        /* Max posts column - center aligned */
        .table-cell.rss_pi_feed_max_posts {
            font-weight: 600;
            font-size: 15px;
            text-align: center;
        ...
        /* Settings container becomes card */
        #rsspi-settings-table .inside {
            background: var(--card-bg);
            border: 1px solid var(--border);
            border-radius: 8px;
            padding: 20px;
        ...
        /* Remove old WP table look */
        #rsspi-settings-table table {
            border: none;
            width: 100%;
            border-collapse: collapse;
        }

        #rsspi-settings-table td {
            border: none;
            padding: 14px 10px;
            vertical-align: top;
        }

        #rsspi-settings-table tr {
            border-bottom: 1px solid var(--border);
        }

        #rsspi-settings-table tr:last-child {
            border-bottom: none;
        }

        #rsspi-settings-table table tr td:first-child {
            width: 300px;
            padding-right: 20px;
        }
