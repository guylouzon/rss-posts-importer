<div class="wrap">
	<h2><?php esc_html_e("Rss Post Importer Log", 'rss-pie'); ?></h2>
	<div id="poststuff">
		<div id="post-body" class="metabox-holder columns-2">
			<div id="postbox-container-2" class="postbox-container">
				...
				<a href="#" class="button button-large button-primary show-main-ui"><?php esc_html_e("Ok, all done", "rss-pie"); ?></a> 
				<a href="#" class="button button-large button-warning clear-log"><?php esc_html_e("Clear log", "rss-pie"); ?></a> 
				<div class="log">
